...
const TopNavigation = () => {
	...
	return (
		<div className="top-navigation fixed top-0 right-0">
			<HashtagIcon />
...
const Search = () => (
	<div className="search">
		<input className="search-input select-none" type="text" placeholder="Szukaj" />
...
const Title = ({ username }) => (
	<h5 className="title-text select-none">{username}</h5>
);
